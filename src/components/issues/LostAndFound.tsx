...
const ENTRIES_KEY = "lostfound_entries";
const PICKABLE_KEY = "lostfound_pickable_map";
const CSV_META_KEY = "lostfound_csv_meta";
          ...
          <ul className="divide-y divide-border">
            {sortedEntries.map(({ e: entry, i }) => {
              ...
              return (
                <li
                  key={`${entry.sku}-${i}`}
                  className="grid grid-cols-[1fr_0.5fr_1fr_1fr_1fr_1fr_32px] gap-8 items-center px-4 py-2 text-sm"
                >
